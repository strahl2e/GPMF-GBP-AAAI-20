...
extern int daxpy_(ptrdiff_t *, double *, double *, ptrdiff_t *, double *, ptrdiff_t *);
extern int dscal_(ptrdiff_t *, double *, double *, ptrdiff_t *);
extern int dcopy_(ptrdiff_t *n, double *sx, ptrdiff_t *incx, double *sy, ptrdiff_t *incy);
...
int TRON::trcg(double delta, double *g, double *s, double *r, double *cg_rnorm)
{
	int i;
	ptrdiff_t n = fun_obj->get_nr_variable();
	ptrdiff_t inc = 1;
